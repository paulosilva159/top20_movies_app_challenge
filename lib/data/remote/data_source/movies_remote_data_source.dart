...
import 'package:tokenlab_challenge/data/remote/model/movies_remote_model.dart';
...
class MoviesRemoteDataSource {
  ...
  Future<List<MovieShortDetailsRM>> getMoviesList() => dio
      .get(
        PathBuilder.moviesList(),
      )
      .then(
  ...
  Future<MovieLongDetailsRM> getMovieDetails(int movieId) => dio
      .get(
        PathBuilder.movie(movieId),
      )
      .then(
